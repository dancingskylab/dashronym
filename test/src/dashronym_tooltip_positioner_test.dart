...
void main() {
  ...
  group('DashronymTooltipPositioner.baseOffset', () {
    test('returns offset below anchor for LTR', () {
      final anchorSize = const Size(120, 20);
      final offset = DashronymTooltipPositioner.baseOffset(
  ...
  group('DashronymTooltipPositioner.resolveOffset', () {
    test('matches base offset when tooltip fits inside viewport (LTR)', () {
      ...
      final offset = DashronymTooltipPositioner.resolveOffset(
      ...
      final base = DashronymTooltipPositioner.baseOffset(
        anchorSize: anchorSize,
        theme: theme,
        direction: TextDirection.ltr,
      );
    ...
    test('mirrors horizontally for RTL when space allows', () {
      ...
      final ltr = DashronymTooltipPositioner.resolveOffset(
        overlaySize: overlaySize,
        anchorTopLeft: anchorTopLeft,
        anchorSize: anchorSize,
        tooltipSize: tooltipSize,
      ...
      final rtl = DashronymTooltipPositioner.resolveOffset(
        overlaySize: overlaySize,
        anchorTopLeft: anchorTopLeft,
        anchorSize: anchorSize,
        tooltipSize: tooltipSize,
